//Q15. Write a ts program to input all sides of a triangle and check whether triangle is valid or not.


var side1:any=prompt("Enter the triangle sider 1")
var side2:any=prompt("Enter the triangle sider 2")
var side3:any=prompt("Enter the triangle sider 3")
